...
exports.CopilotDetector = void 0;
...
class CopilotDetector {
     ...
     * ```
     */
    async detectCopilotExtensions(extensionsPath) {
        const components = [];
        try {
     ...
     * ```
     */
    async detectCopilotConfig(settingsPath) {
        const components = [];
        try {
...
exports.CopilotDetector = CopilotDetector;
